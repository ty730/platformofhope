				...
				<div className="mini-container">
					...
					<div className="row mt-md-2 mt-lg-2 mt-sm-2 mt-2">
						<div className="mt-md-3 mt-lg-3 mt-sm-5 mt-5 lr-container">
							...
							<p>Doris Smith is a dynamic leader and social advocate, driven by a deep passion for improving the lives of underserved populations. As the Founder and Executive Director of Platform of Hope, Doris is committed to addressing homelessness and supporting families in need. With a mission focused on feeding, housing, and clothing families, Doris’ work is rooted in compassion, service, and social change. She is particularly dedicated to supporting those experiencing homelessness, working tirelessly to transform their lives through essential services and empowerment programs.</p>
