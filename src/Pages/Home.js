    ...
    const homeColumn = [
        {
            ...
            title: "Volunteer",
            paragraph:
                "Volunteering changes lives. You may volunteer by working events, making calls to potential donors, sorting donated goods and other tasks.",
        ...
        },
        {
            ...
            title: "Get Help",
            paragraph:
                "Platform of Hope distributes material essentials, non-perishables while providing financial assistance. Applications are accepted when funding is available.",
            alt: "holding hands",
            link: "/gethelp",
        },
        {
            ...
            title: "Donate",
            paragraph:
                "Platform of Hope greatly appreciates support of any kind. The quickest, most efficient way to give is through monetary donations.",
            alt: "praying hands",
            link: "/donate",
        },
    ];
        ...
        <div className="home">
            ...
            <div className="home-top">
                <div>
                    ...
                    <p>
                        Platform of Hope is an initiative designed to feed,
                        house, clothe, and employ homeless families while
                        empowering and transforming lives of the economically
                        underserved. We successfully provide support and restore
                        lives of homeless families in Atlanta, Georgia and
                        surrounding counties. Platform of Hope facilitates in
                        local correctional facilities then partners released
                        offenders with employers for reemployment.
                    </p>
                    <Link to="/about">
            ...
            <div className="home-container">
                ...
                >
                    <path
                        fill="#ffffff"
                        fillOpacity="1"
                        d="M0,160L26.7,144C53.3,128,107,96,160,112C213.3,128,267,192,320,197.3C373.3,203,427,149,480,149.3C533.3,149,587,203,640,192C693.3,181,747,107,800,85.3C853.3,64,907,96,960,144C1013.3,192,1067,256,1120,266.7C1173.3,277,1227,235,1280,224C1333.3,213,1387,235,1413,245.3L1440,256L1440,0L1413.3,0C1386.7,0,1333,0,1280,0C1226.7,0,1173,0,1120,0C1066.7,0,1013,0,960,0C906.7,0,853,0,800,0C746.7,0,693,0,640,0C586.7,0,533,0,480,0C426.7,0,373,0,320,0C266.7,0,213,0,160,0C106.7,0,53,0,27,0L0,0Z"
                    ></path>
                </svg>
            </div>
                            ...
                            <div className="upcomingEvents d-flex align-items-center justify-content-center">
                                <Row>
                                    ...
                                    <Col
                                        ...
                                        md={12}
                                        sm={12}
                                        className="pastEventsCol align-items-sm-center justify-sm-content-center d-flex flex-column align-items-xl-start"
                                    >
                                        <h3 className="text-md-center ml-3 upcomingTitle">
                                            Upcoming Events
                                        </h3>
            ...
            <div className="home-video container-fluid">
                ...
                <div className="home-overlay">
                    <div className="home-text">
                        ...
                        <p>
                            Check out our full image and video gallery
