    ...
    return (
        <div>
            ...
            <div className="media-container">
                ...
                <div>
                    <h2>Videos</h2>
                    <video className="large-video" controls>
                    ...
                    <div className="small-videos">
                        <iframe
                            width="560"
                            height="315"
                            src="https://www.youtube.com/embed/wsR5hJw8VnY?si=aMX6eB48ABvuwPdy"
                        ...
                        ></iframe>
                        <video controls>
                            <source src={coatVideo}></source>
                        </video>
                        <iframe
                            classname="slider-img"
                            width="560"
                            height="315"
                            src="https://www.youtube.com/embed/wkZeEiLNLLc"
                            title="YouTube video player"
                            frameborder="0"
